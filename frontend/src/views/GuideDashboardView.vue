    ...
    <div class="container py-4">
      ...
      <div class="mb-6">
        ...
        <div class="grid grid-cols-2 gap-3">
          <button class="btn btn-outline flex-col h-auto py-4 gap-2" @click="router.push('/guide/tours/new')">
            <Map :size="24" class="text-primary" />
            <span>Crear Tour</span>
          </button>
          <button class="btn btn-outline flex-col h-auto py-4 gap-2" @click="router.push('/guide/bookings')">
      ...
      <div>
        <div class="flex justify-between items-center mb-3">
          ...
          <button class="btn btn-ghost btn-sm" @click="router.push('/guide/bookings')">Ver todas</button>
        </div>
            ...
            >
              <div>
                ...
                <p class="text-xs text-secondary mt-1">
                  {{ new Date(booking.schedule_start).toLocaleDateString('es-MX') }} • {{ booking.guest_count }} pax
                </p>
              </div>
              <div class="flex items-center gap-3">
                <span class="badge" :class="booking.status === 'confirmed' ? 'badge-success' : 'badge-warning'">
                  {{ booking.status }}
                </span>
...
.bg-secondary-light { background: var(--color-secondary-50); }
