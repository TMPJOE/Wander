...
import TourWizard from '../components/tour-wizard/TourWizard.vue'
...
function handlePreview() {
  ...
  const returnPath = isEdit.value ? `/guide/tours/${tourId.value}/edit` : '/guide/tours/new'
...
<template>
  <div class="page bg-surface min-h-screen">
    <header class="header">
      <button class="back-btn" @click="router.push('/guide/tours')">
        <ArrowLeft :size="20" />
      </button>
